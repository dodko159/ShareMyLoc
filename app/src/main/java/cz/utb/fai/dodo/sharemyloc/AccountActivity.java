...
public class AccountActivity extends AppCompatActivity {
    ...
    private Button btnChangeEmail, btnChangePassword, btnChangeNameSurname, btnRemoveUser,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangeNameSurname = (Button) findViewById(R.id.change_name_surname);
        ...
        btnChangeNameSurname.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                oldEmail.setVisibility(View.GONE);
                newEmail.setVisibility(View.GONE);
                ...
                shared.saveBooleanToShared(Shared.FROM_ACCOUNT_ACTIVITY, true);

                startActivity(new Intent(AccountActivity.this, NameSurnameActivity.class));
            }
        });
        ...
        btnRemoveUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressBar.setVisibility(View.VISIBLE);
                if (user != null) {
                    DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("names");
                    firebaseDatabase.child(user.getUid()).removeValue();
                    firebaseDatabase = FirebaseDatabase.getInstance().getReference("positions");
                    if(firebaseDatabase != null) firebaseDatabase.child(user.getUid()).removeValue();
